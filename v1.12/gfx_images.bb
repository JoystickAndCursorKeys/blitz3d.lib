...
If(strip=0) RuntimeError "Load Error #0000090 "+ filename$
...
Function CreateImageSequence.imagesequence(w,h,count)
	...
	For t = 0 To count-1
			...
			MaskImage(nis\image[t],0,0,0) ;default mask color
...
Function GetImageSequenceBuffer(nis.imagesequence,frame)

	Return ImageBuffer (nis\image[frame])
