...
Function StarsSetBGModePictureBuffer(picbuf)

	g_starsbgbuffer(0)=picbuf
	g_starsbgbuffercnt=1
	
End Function 

Function StarsSetBGPictureScale(scale)

	g_starbgfact=scale
	DebugLog "scale = "+g_starbgfact
		...
		Else
			...
			For s.star = Each star
					...
					If(xx<g_starviewx1 And xx>g_starviewx0 And yy<g_starviewy1 And yy>g_starviewy0) Then
						...
						mycol=ReadPixelFast   (xx/g_starbgfact,yy/g_starbgfact,g_starsbgbuffer(0))
			...
			For s.star = Each star
				...
				For trail=1 To 3
					...
					If(ix<g_starviewx1 And ix>g_starviewx0 And iy<g_starviewy1 And iy>g_starviewy0) Then
						...
						mycol=ReadPixelFast   (ix/g_starbgfact,iy/g_starbgfact,g_starsbgbuffer(ib))
...
Function Stars_Init()
	...
	Stars_SetColors_Fade()


End Function

Function Stars_SetColors_Fade()
