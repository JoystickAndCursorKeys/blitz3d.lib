...
Function InitFontDrawer2.df_font(s$,mytype$)
  filein = ReadFile(s$+".dat")
  ws$ = ReadLine$( filein )
  hs$ = ReadLine$( filein )
	w=ws$
	h=hs$
	...
	df_font_current=New df_font
	df_font_current\picture= LoadAnimImage(s$+"."+mytype$,w,h,0,52)		
	df_font_current\w=w
	df_font_current\h=h
	Return df_font_current 
End Function
...
Function DrawFontCustomW(cw#,x,y,Txt$,font.df_font)
	...
	For	cc = 0 To textlen - 1								
		...
		If cr$ <> " "
			; Draw the letters 
			If(cra>51 or cra<0) Then cra=51
